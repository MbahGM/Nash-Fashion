...
def admin_header(active=""):
    ...
    return f'''<header class="	bg-black text-white p-4 flex justify-between items-center flex-wrap"><h1 class="text-xl font-bold">{STORE_EMOJI} {STORE_NAME} Admin</h1><nav class="flex flex-wrap">{nav}</nav></header>'''
